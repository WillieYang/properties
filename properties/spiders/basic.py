...
class BasicSpider(scrapy.Spider):
    ...
    def parse(self, response):
    	...
    	l.add_xpath('price', './/*[@itemprop="listing_price"][1]/text()',
    	...
    	l.add_xpath('address', '//*[@itemtype="http://schema.org/Product"]'
    		'[1]/text()', MapCompose(unicode.strip))

    	l.add_xpath('image_urls', '//*[@itemprop="image"]'
    		'[1]/@src', MapCompose(lambda i: urlparse.urljoin(response.url, i)))
